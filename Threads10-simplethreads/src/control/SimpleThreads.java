...
public class SimpleThreads {
	...
	private static class MessageLoop implements Runnable {
		public void run() {
			String importantInfo[] = { "Las yeguas comen avena", "Sí, comen avena",
					"Los corderos pequeños comen hiedra", "Por tanto, un niño también comerá hiedra" };
			try {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		// Si el argumento en línea de comandos está presente, se pone patience en
		// segundos
		if (args.length > 0) {
			try {
